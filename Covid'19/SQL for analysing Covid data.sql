...
/* check first 10 rows */
SELECT TOP 10 * FROM "Covid19"..dbo.Data

/* check how many rows */
SELECT COUNT(*) AS 'Nb of row'
FROM "Covid19"..dbo.Data;
/* how many month */
SELECT DATEPART(YEAR, Date) AS 'Year', COUNT(DISTINCT(MONTH(Date))) AS 'NB of month' FROM "Covid19"..dbo.Data
GROUP BY DATEPART(YEAR, Date)
/*start_date - end_date*/
SELECT MIN(Date) AS 'start_date', MAX(Date) AS 'end_date' FROM "Covid19"..dbo.Data
...
--TOP 5
SELECT TOP 5 * FROM "Covid19"..dbo.Data
